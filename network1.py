...
def generator_simplified_api(inputs, batch_size, is_train=True, reuse=False):
    ...
    with tf.variable_scope("generator", reuse=reuse):
        ...
        net_h0 = tf.layers.batch_normalization(net_h0, epsilon=1e-5, gamma_initializer=gamma_init,
                                               name='g/h0/batch_norm')
        net_h0 = tf.nn.leaky_relu(net_h0, 0.2)
        ...
        net_h1 = tf.layers.batch_normalization(net_h1, epsilon=1e-5, gamma_initializer=gamma_init,
                                               name='g/h1/batch_norm')
        net_h1 = tf.nn.leaky_relu(net_h1, 0.2)
        ...
        net_h2 = tf.layers.batch_normalization(net_h2, epsilon=1e-5, gamma_initializer=gamma_init,
                                               name='g/h2/batch_norm')
        net_h2 = tf.nn.leaky_relu(net_h2, 0.2)
        ...
        net_h3 = tf.layers.batch_normalization(net_h3, epsilon=1e-5, gamma_initializer=gamma_init,
        ...
        net_h4 = tf.layers.batch_normalization(net_h4, epsilon=1e-5, gamma_initializer=gamma_init,
        ...
        net_h5 = tf.layers.batch_normalization(net_h5, epsilon=1e-5, gamma_initializer=gamma_init,
                                               name='g/h5/batch_norm')
        net_h5 = tf.nn.leaky_relu(net_h5, 0.2)
