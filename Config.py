...
flags.DEFINE_string("checkpoint_dir", "/data/checkpoint69", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("sample_dir", "/data/samples69", "Directory name to save the image samples [samples]")
flags.DEFINE_string("feature_dir", "/data/features69", "Directory name to save features")
