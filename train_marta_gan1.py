...
flags.DEFINE_string("checkpoint_dir", "/data/checkpoint19", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("sample_dir", "/data/samples19", "Directory name to save the image samples [samples]")
