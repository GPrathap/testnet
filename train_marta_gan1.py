...
flags.DEFINE_string("checkpoint_dir", "/data/checkpoint16", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("sample_dir", "/data/samples16", "Directory name to save the image samples [samples]")
